...
<!--   <a href="#">
  ...
  <p align="center">
    restaurant landing page bootstrap 5
<!--     <br />
...
<!-- ABOUT THE PROJECT -->
## About The Project
![Screenshot (10)](https://user-images.githubusercontent.com/85431653/157615791-75c6b941-e841-4a73-b1be-1d62b6166c2e.png)



``First of all I want to apologize if my English is bad because I am here speaking with the help of a google translator``

This project is a landing page that i created because in that time i was bored and then i create this template by using framework bootstrap 5 but because i'm too lazy i dont make it responsive LOL
...
1. Clone the repo
   ```
   $git clone https://github.com/DafiNMaulana/sport-event-landing-page.git
   ```
